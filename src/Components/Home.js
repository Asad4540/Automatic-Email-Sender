        ...
        <Table>
          <TableHead>
            <StyledTableRow >
              ...
              <StyledTableCell className={classes.emailAdminColumn} ><b>Email Administration</b></StyledTableCell>
            </StyledTableRow>
          </TableHead>
          <TableBody>
            {clients.map((client) => {
              ...
              switch (client.emailSent) {
                case 'NA':
                  emailAdminContent = (
                    <>
                      <EmailStatusLabel disabled color="default">The Email is Ready to send</EmailStatusLabel>
                ...
                case 'Sent':
                  emailAdminContent = (
                    <>
                      <EmailStatusLabel disabled color={getLabelColor(client.emailSent)}>Email sent successfully</EmailStatusLabel>
